...
toelist = ...
    'response/concat_chan_49_50_electrode_18_20/10 reps/ss001m_497_17_s1_toe.txt';
...
%% Load and prepare spectrogram of testing stimulus
toelist = ...
    'response/concat_chan_49_50_electrode_18_20/30 reps/ss001m_497_17_s1_2fast_toe.txt';
...
%% Load and prepare spectrogram of testing stimulus
toelist = ...
    'response/concat_chan_49_50_electrode_18_20/30 reps/ss001m_497_17_s1_shift_1_toe.txt';
stop = 60; %30 for fast, 60 for normal, 90 for slow
[~, psth, spec]= plot_raster_SMI2(toelist, start, stop, step, nfft, window, overlap);
time_compress = 1; %5.74 for fast, 11.5 for normal, 17.2 for slow
[tstimulus, tresponse, tresponse_nor, ~, Nsample, tNdim]=compression(spec, psth', freq_compress, time_compress); 
...
%% Load and prepare spectrogram of testing stimulus
toelist = ...
    'response/concat_chan_49_50_electrode_18_20/30 reps/ss001m_497_17_s1_shift_6_toe.txt';
stop = 60; %30 for fast, 60 for normal, 90 for slow
[~, psth, spec]= plot_raster_SMI2(toelist, start, stop, step, nfft, window, overlap);
[tstimulus, tresponse, tresponse_nor, ~, Nsample, tNdim]=compression(spec, psth', freq_compress, time_compress); 
close all 
...
%% Load and prepare spectrogram of testing stimulus
toelist = ...
    'response/concat_chan_49_50_electrode_18_20/30 reps/ss001m_497_17_s1_slow_toe.txt';
...
hold on; 
plot(step, percdata(1:11,1));
plot(step, percdata(1:11,2));
plot(step, percdata(1:11,3));
plot(step, percdata(1:11,4));
plot(step, percdata(1:11,5));
% y=0; plot(step, y, 'linewidth', 10);
grid on
xlabel('time bin resolution (s)');
title('percentage correlation coefficient resolved from 20ms to 100ms by step of 10ms');
ylabel('% correlation coefficient');
legend('m\_497\_17\_s1','m\_497\_17\_s1\_2fast','m\_497\_17\_s1\_slow');%, ...
...
% figure; 
% bar(song,corre_coef');
% title('correlation coefficient with different stimuli');
% ylabel('correlation coefficient');
% legend('19.4ms','27.2ms','35ms','42.8ms','50.5ms','58.3ms','66.1ms','73.9ms','81.6ms', '89.4ms','97.2ms');
