...
toelist = ...
    'response/concat_chan_22_23_electrode_10_7/ss001m_497_17_s1_2fast_toe.txt';
start = 0; 
...
toelist = ...
    'response/concat_chan_41_42_electrode_28_25/ss001m_497_17_s1_m_462_s2prime_2fast_toe.txt';
start = 0; 
stop = 30; %30 for fast, 60 for normal, 90 for slow
figure; 
...
toelist = ...
    'response/concat_chan_41_42_electrode_28_25/ss001m_497_17_s1_2fast_toe.txt';
start = 0; 
stop = 30; %30 for fast, 60 for normal, 90 for slow
figure; 
...
toelist = ...
    'response/concat_chan_41_42_electrode_28_25/ss001165_s_12_2fast_toe.txt';
start = 0; 
stop = 30; %30 for fast, 60 for normal, 90 for slow
figure; 
...
time_compress = 5.74; %5.74 for fast, 11.5 for normal, 17.2 for slow
